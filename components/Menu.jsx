...
export default function Menu() {
  ...
  return (
    <header className="w-screen py-7.5 px-14 fixed top-0 left-0 z-50">
      ...
      <div className={showMenu ? " smneu absolute sm:w-lg w-96 h-screen py-17.5 top-0 right-0 bg-white z-40 overflow-hidden duration-1000" : " smneu absolute sm:w-lg w-96 h-screen py-17.5 top-0 right-[-130%] bg-white z-40 overflow-hidden duration-1000"} >
